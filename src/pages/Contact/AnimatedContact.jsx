                ...
                <div className="md:w-[50%] md:ml-11 md:pt-0 pt-6 md:mb-0 mb-9 flex flex-col pl-9 justify-center  gap-5">
                    ...
                    <motion.div whileInView={{ y: [70, 0], opacity: [0, 1] }}
                        ...
                        <Link to="https://leetcode.com/abaadali899/" target='_blank'>
                            <h2 className='md:text-2xl text-xl text-white font-semibold'>LeetCode</h2>
                            <span className='text-green-500 font-semibold'>LeetCode Profile :</span>
                            <span className='hover:underline text-white'>
                                Abaad Ali
                            </span>
